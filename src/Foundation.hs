      ...
      where
        ...
        hasPermissionTo Entity{entityKey = userId} _ (ManageMerchant merchantId) = do
          ...
          return $ case maybeMerchant of
            Just Entity{entityKey = userMerchantId} | merchantId == userMerchantId ->
              Authorized
            Just Entity{} ->
              Unauthorized ""
            Nothing ->
        ...
        hasPermissionTo Entity{} _ (ManageOrganization merchantId organizationId) = do
          ...
          return $ case maybeOrg of
            Just org | organizationMerchantId org == merchantId ->
              Authorized
            Just Organization{} ->
              Unauthorized ""
            Nothing ->
        ...
        hasPermissionTo Entity{} _ (ManageOrganizationSchedule organizationId organizationScheduleId) = do
          ...
          return $ case mSchedule of
            Just schedule | organizationScheduleOrganizationId schedule == organizationId ->
              Authorized
        ...
        hasPermissionTo Entity{} _ (ManageProperty organizationId propertyId) = do
          mm <- get propertyId
          return $ case mm of
            Just m | propertyOrganizationId m == organizationId ->
              Authorized
            Just Property{} ->
              Unauthorized ""
            Nothing ->
...
instance YesodAuth App where
    ...
    authPlugins app =
      ...
      where
        firebaseAuthPlugin = authFirebase MsgIso639v1 MsgIso3166v1 FirebaseSettings{
